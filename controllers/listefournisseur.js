...
exports.fournisseur = async (req, res) => {
    ...
    try {
        ...
        const Fournisseurid = await fournisseurQueries.getFournisseursById(req.query.id);
        let Result=[];
        if (Fournisseur.result !== null) {
            const fournisseur = await fournisseurQueries.getFournisseurs(Fournisseurid);
            ...
            res.render("listefournisseur",{Result} )
        }
